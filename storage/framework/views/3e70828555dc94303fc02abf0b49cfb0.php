<a href="<?php echo e(route('transaksi.index')); ?>" class="text-decoration-none">
    <div class="card h-100 border-0 shadow-sm" style="border-radius:.75rem;">
        <div class="card-body p-3">
            ...
            <div class="text-muted" style="font-size:.72rem;"><?php echo e(now()->translatedFormat('d F Y')); ?></div>
        </div>
    </div>
</a>
<?php /**PATH C:\laragon\www\Finanku\resources\views/dashboard/widgets/card-transaksi.blade.php ENDPATH**/ ?>