        ...
        <div class="d-flex justify-content-between align-items-start gap-2">
            <div class="overflow-hidden">
                ...
                <h2 class="fw-bold mb-0" style="font-size:clamp(1.25rem, 5vw, 2rem);word-break:break-all;">
                    Rp <?php echo e(number_format($summary['saldo_total'] ?? 0, 0, ',', '.')); ?>

                </h2>
            </div>
            <div class="text-end small flex-shrink-0" style="opacity:.85;">
                <div><?php echo e(now()->translatedFormat('F Y')); ?></div>
                <div class="mt-1"><?php echo e(auth()->user()->household?->nama ?? 'Household'); ?></div>
            </div>
        </div>
        ...
        <div class="row g-2 g-sm-3">
            <div class="col-4">
                ...
                <div class="fw-bold" style="font-size:clamp(.75rem, 2.5vw, 1.1rem);word-break:break-all;">
                    Rp <?php echo e(number_format($summary['transaksi_bulan_ini']['pemasukan'] ?? 0, 0, ',', '.')); ?>
            ...
            <div class="col-4">
                ...
                <div class="fw-bold" style="font-size:clamp(.75rem, 2.5vw, 1.1rem);word-break:break-all;">
                    Rp <?php echo e(number_format($summary['transaksi_bulan_ini']['pengeluaran'] ?? 0, 0, ',', '.')); ?>

                </div>
            </div>
            <div class="col-4">
                <?php $selisih = $summary['transaksi_bulan_ini']['selisih'] ?? 0; ?>
                <p class="mb-1" style="font-size:.7rem;opacity:.75;">Cashflow</p>
                <div class="fw-bold" style="font-size:clamp(.75rem, 2.5vw, 1.1rem);word-break:break-all;color:<?php echo e($selisih >= 0 ? '#86efac' : '#fca5a5'); ?>">
...
<?php /**PATH C:\laragon\www\Finanku\resources\views/dashboard/widgets/hero-saldo.blade.php ENDPATH**/ ?>