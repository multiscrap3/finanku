...
@section('page-title', 'Edit Hutang/Piutang')
...
<div class="col-12 col-lg-8">
    <div class="card border-0 shadow-sm" style="border-radius:.75rem;">
        <div class="card-body p-4 p-md-5">
            <h6 class="fw-semibold mb-4">Edit Data</h6>
            <form method="POST" action="{{ route('hutang-piutang.update', $hutangPiutang) }}">
                ...
                <div class="mb-3">
                    <label class="form-label fw-medium">
                        {{ $hutangPiutang->jenis === 'hutang' ? 'Nama Pemberi Hutang' : 'Nama Penerima Piutang' }}
                    </label>
                ...
                <div class="d-flex gap-2 pt-2">
                    ...
                    <a href="{{ route('hutang-piutang.show', $hutangPiutang) }}" class="btn btn-outline-secondary flex-fill">Batal</a>
                </div>
            </form>
        </div>
    </div>
