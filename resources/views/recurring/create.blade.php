...
@section('title', 'Tambah Transaksi Rutin')
@section('page-title', 'Tambah Transaksi Rutin')
            ...
            <form method="POST" action="{{ route('recurring.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="keterangan" value="{{ old('keterangan') }}" required
                           placeholder="Contoh: Gaji, Cicilan motor, Netflix..."
                ...
                <div class="mb-3">
                    ...
                    <select name="frekuensi" required class="form-select">
                        <option value="harian"   {{ old('frekuensi') === 'harian' ? 'selected' : '' }}>Harian</option>
                        <option value="mingguan" {{ old('frekuensi') === 'mingguan' ? 'selected' : '' }}>Mingguan</option>
                        <option value="bulanan"  {{ old('frekuensi', 'bulanan') === 'bulanan' ? 'selected' : '' }}>Bulanan</option>
                ...
                <div class="mb-3">
                    <label class="form-label fw-medium">Sumber Dana <span class="text-danger">*</span></label>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-6">
                        <label class="form-label fw-medium">Selesai <span class="text-muted fw-normal">(opsional)</span></label>
