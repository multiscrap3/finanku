...
@section('page-title', 'Edit Tujuan Tabungan')
    ...
    <div class="card border-0 shadow-sm" style="border-radius:.75rem;">
        <div class="card-body p-4 p-md-5">
            <form method="POST" action="{{ route('tabungan.update', $tabungan) }}">
                ...
                <div class="mb-3">
                    <label class="form-label fw-medium">Nama Tujuan</label>
                ...
                <div class="mb-3">
                    <label class="form-label fw-medium">Target Jumlah</label>
                ...
                <div class="d-flex gap-2 pt-2">
                    ...
                    <a href="{{ route('tabungan.show', $tabungan) }}" class="btn btn-outline-secondary flex-fill">Batal</a>
                </div>
            </form>
        </div>
    </div>
